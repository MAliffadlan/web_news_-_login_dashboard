...
<html>
	...
	<body>
		...
		<ol>
		<?php
		$query = "SELECT A.id_berita, B.nm_kategori, A.judul, A.pengirim, A.tanggal FROM berita A, kategori B WHERE
		A.id_kategori=B.id_kategori ORDER BY A.id_berita DESC";
...
//tampilkan arsip berita
		...
		echo "<b>Action : </b><a href='edit_berita.php?id=$id_berita.php?id=$id_berita'>Edit</a><br>";
		echo "<b>Action : </b><a href='delete_berita.php?id=$id_berita.php?id=$id_berita'onClick='return tanya()'>Delete</a><br>";
		echo "</small></li><br><br>";
	}
	?>
	</ol>
